...
public class DropOffAdapter extends ArrayAdapter<getTiresOnTrucks> {
    Context context;
    List<getTiresOnTrucks> list;
    public DropOffAdapter(@NonNull Context context, @LayoutRes int resource, List<getTiresOnTrucks> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.textView9.setText(tir.getQuantity());
